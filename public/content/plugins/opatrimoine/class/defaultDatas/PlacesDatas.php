...
class PlacesDatas
{
    ...
    public $places = [
        ...
        [
            ...
            'post_type' => 'place',
            'post_status' => 'publish',
            'tax_input' => ['place-type' => ['Monument', 'Monument mémorial']],
            // NTH 'open' en évolution potentielle
            'comment_status' => 'closed',
            // ACF custom fields
        ...
        [
            ...
            'post_excerpt' => 'Construite en partie à partir de 1145, et reconstruite en vingt-six ans après l\'incendie de 1194, la cathédrale de Chartres est le monument par excellence de l\'art gothique français.',
            'post_type' => 'place',
            'post_status' => 'publish',
            'tax_input' => ['place-type' => ['Cathédrale']],
            // NTH 'open' en évolution potentielle
        ...
        [
            ...
            'post_excerpt' => 'Admirable par ses proportions et l\'unité de sa conception, la cathédrale Saint-Étienne de Bourges, construite entre la fin du XIIe et la fin du XIIIe siècle',
            'post_type' => 'place',
            'post_status' => 'publish',
            'tax_input' => ['place-type' => ['Cathédrale']],
            // NTH 'open' en évolution potentielle
        ...
        [
            ...
            'post_excerpt' => 'Lieu de résidence privilégié de la monarchie française de Louis XIV à Louis XVI, le château de Versailles, embelli par plusieurs générations d\'architectes',
            'post_type' => 'place',
            'post_status' => 'publish',
            'tax_input' => ['place-type' => ['Château']],
            // NTH 'open' en évolution potentielle
        ...
        [
            ...
            'post_excerpt' => 'Le musée du Louvre est une préfiguration imaginée en 1775-1776 par le comte d\'Angiviller, directeur général des Bâtiments du roi, comme lieu de présentation des chefs-d\'œuvre de la collection de la Couronne.',
            'post_type' => 'place',
            'post_status' => 'publish',
            'tax_input' => ['place-type' => ['Musée']],
            // NTH 'open' en évolution potentielle
        ...
        [
            ...
            'post_excerpt' => 'Communément appelé « centre Pompidou », ou plus familièrement « Beaubourg » est un établissement pluridisciplinaire né de la volonté du président Georges Pompidou',
            'post_type' => 'place',
            'post_status' => 'publish',
            'tax_input' => ['place-type' => ['Musée']],
            // NTH 'open' en évolution potentielle
